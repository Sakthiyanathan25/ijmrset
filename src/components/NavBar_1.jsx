...
export default function NavBar_1() {
  ...
  return (
    ...
    >
      <div
        className={`bg-white  px-5 flex justify-between items-center p-2 transition-all duration-300 ease-in-out ${isSticky ? '' : 'rounded-xl'}`}
      ...
      >
        ...
        <ul
          ...
          className="w-[50%] flex justify-around text-black font-lora text-lg font-semibold rounded-xl"
        >
          <li
            onMouseEnter={() => setOnNav('Home')}
          ...
          >
            Editor Board
            <img src={Arrow} alt="arrow" className={`h-3 mt-1 transition-all duration-300 ease-in-out ${onNav ==="EditorBoard" ? 'rotate-180' :''}`} />
            <div
              className={`absolute z-10 w-[130px] x flex-col  shadow-xl divide-y-2 rounded-md bg-white top-14 transition-all duration-300 ease-in-out ${onNav === 'EditorBoard' ? 'flex' : 'hidden'} </li>}`}
            >
          ...
          <li
            onMouseEnter={() => setOnNav('Authors')}
            className="h-12 flex items-center"
          >
            Authors
          </li>
          <li
            onMouseEnter={() => setOnNav('Issues')}
            className="h-12 flex items-center"
          >
            Issues
          </li>
          <li
            onMouseEnter={() => setOnNav('Reviewer')}
            className="h-12 flex items-center"
          >
            Reviewer
          </li>
          <li
            onMouseEnter={() => setOnNav('Contact')}
            className="h-12 flex items-center"
          >
            Contact
          </li>
